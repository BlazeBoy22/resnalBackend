    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    if (!res.data.includes("Please check website after 4 hour --- !!!")) return [3 /*break*/, 7];
                    console.log("IP Blocked");
                    return [3 /*break*/, 10];
                case 7:
                    if (!res.data.includes("Semester : 7")) return [3 /*break*/, 8];
                    results_1 = [];
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var Result, json, _i, json_1, student, res, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                Result = [];
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, csv().fromFile("3rd.csv")];
            case 2:
                json = _a.sent();
                _i = 0, json_1 = json;
                _a.label = 3;
            case 3:
                if (!(_i < json_1.length)) return [3 /*break*/, 8];
                student = json_1[_i];
                console.log("".concat(json.indexOf(student) + 1, "/").concat(json.length, " - Name: ").concat(student.USN, " - Section: ").concat(student.Section));
                _a.label = 4;
            case 4:
                _a.trys.push([4, 6, , 7]);
            ...
            case 7:
                ...
                return [3 /*break*/, 3];
            case 8:
                fs.writeFile("result.json", JSON.stringify(Result, null, 2), function (e) {
                    if (e)
                        throw e;
                });
                console.log("=========================");
